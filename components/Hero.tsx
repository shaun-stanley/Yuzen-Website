...
export default function Hero(){
  return (
    <section className="relative overflow-hidden pt-40 pb-32">
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-mist/80 via-white to-rice"></div>
      <div className="absolute inset-y-0 right-0 w-1/2 -z-10 bg-[radial-gradient(circle_at_center,rgba(11,107,58,0.15),transparent)]"></div>
      <div className="mx-auto max-w-[1200px] px-6 md:px-8 grid md:grid-cols-2 items-center gap-10">
        <div>
          ...
          <div className="mt-8 flex gap-3">
            <Link href={'/request-access' as Route} className="px-5 py-3 rounded-xl bg-gradient-to-r from-ceremonial to-gyokuro text-white shadow-soft">Request access</Link>
            <Link href="/catalog" className="px-5 py-3 rounded-xl border border-black/10 bg-white/70 backdrop-blur-sm shadow-soft hover:bg-white">View catalog</Link>
          </div>
        ...
        <div className="rounded-3xl glass p-8 bg-white/60">
          ...
          <a href="/samples" className="mt-6 inline-block px-4 py-2 rounded-lg bg-gradient-to-r from-ceremonial to-gyokuro text-white">Order sample kit</a>
        </div>
      </div>
    </section>
  )
